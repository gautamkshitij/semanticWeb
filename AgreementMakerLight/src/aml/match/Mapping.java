...
//Public Methods
    ...
    public String toString() {
        ...
        String out = "\n\n SourceID:   " + uris.getURI(sourceId) + "\t Name:   " + source.getName(sourceId) +
                "\n TargetID:   " + uris.getURI(targetId) + "\t TargetName   " + target.getName(targetId) +
                "\n Similarity:   " + similarity + "\t Relation:   " + rel.toString() + "\n\n";
        if (!s.equals(MappingStatus.UNKNOWN))
            out += "\n" + s;
        return out;
    }
